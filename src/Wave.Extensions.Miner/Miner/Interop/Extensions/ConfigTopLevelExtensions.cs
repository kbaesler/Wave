...
namespace Miner.Interop.Extensions
{
    ...
    public static class ConfigTopLevelExtensions
    {
        ...
        public static Dictionary<int, List<IMMAutoValue>> GetAutoValues(this IMMConfigTopLevel source, IObjectClass table, mmEditEvent editEvent)
        {
            ...
            {
                IMMSubtype mmsubtype = source.GetSubtypeByID(table, subtypeCode, false);
                if (mmsubtype == null) continue;

                var autoValues = mmsubtype.GetAutoValues(table, editEvent);
        ...
        /// <summary>
        ///     Sets the field visibility to the specified <paramref name="visible" /> value for all subtypes in the specified
        ...
        public static void SetFieldVisibility(this IMMConfigTopLevel source, IObjectClass table, bool visible, params string[] fieldNames)
        {
            ...
            foreach (var subtypeCode in subtypes.Subtypes.AsEnumerable().Select(o => o.Key))
            {
                source.SetFieldVisibility(table, subtypeCode, visible, fieldNames);
            }
        }

        /// <summary>
        ///     Sets the field visibility to the specified <paramref name="visible" /> value for the subtype in the specified
        ///     <paramref name="table" /> object class
        ///     that match the field names.
        /// </summary>
        /// <param name="source">The source.</param>
        ...
        /// <param name="fieldNames">The field names.</param>
        /// <exception cref="ArgumentNullException">fieldName</exception>
        public static void SetFieldVisibility(this IMMConfigTopLevel source, IObjectClass table, int subtypeCode, bool visible, params string[] fieldNames)
        {
            if (source == null) return;
            if (fieldNames == null) throw new ArgumentNullException("fieldNames");
            ...
            {
                subtype.SetFieldVisibility(fieldName, visible);
            }
        }
