...
namespace ESRI.ArcGIS.Geodatabase
{
    ...
    public static class WorkspaceAsyncExtensions
    {
        ...
        public static Task<IFeatureClass> GetFeatureClassAsync(this IWorkspace source, string modelName)
        {
        ...
        /// <exception cref="ArgumentNullException">modelName</exception>
        /// <exception cref="MissingClassModelNameException"></exception>
        public static Task<ITable> GetTableAsync(this IWorkspace source, string modelName)
        {
