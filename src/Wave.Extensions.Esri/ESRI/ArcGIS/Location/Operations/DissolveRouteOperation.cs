...
namespace ESRI.ArcGIS.Location
{
    ...
    public class DissolveRouteOperation : RouteOperation<DissolveRouteEventData>
    {
        ...
        /// <returns>Returns a <see cref="ITable" /> representing the table that has been created.</returns>
        public ITable Execute(ITable table, IRouteMeasureSegmentation source, IWorkspace outputWorkspace, string outputTableName, IRouteMeasureSegmentation output, ITrackCancel trackCancel, params string[] dissolveFields)
        {
