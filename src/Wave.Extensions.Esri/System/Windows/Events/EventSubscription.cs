...
namespace System.Windows
{
    ...
    public class EventSubscription<TPayload> : IEventSubscription
    {
        ...
        /// </summary>
        /// <returns>
        ///     An <see cref="System.Action{T}" /> with the execution strategy, or <see langword="null" /> if the
        ...
        /// <exception cref="ArgumentNullException">
        ///     An <see cref="ArgumentNullException" /> is thrown if <paramref name="action" />
        ///     is null.
        /// </exception>
