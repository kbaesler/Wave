...
namespace System.Windows
{
    ...
    public abstract class EventBase
    {
        ...
        /// </summary>
        /// <param name="token">
        ///     The <see cref="SubscriptionToken" /> returned by <see cref="EventBase" /> while subscribing to the
        ///     event.
        /// </param>
        /// <returns>
        ///     <see langword="true" /> if there is a <see cref="SubscriptionToken" /> that matches; otherwise
        ///     <see langword="false" />.
        /// </returns>
