...
namespace System.Windows
{
    ...
    public class CompositePresentationEvent<TPayload> : EventBase
    {
        ...
        /// <returns>
        ///     <see langword="true" /> if there is an <seealso cref="Action{TPayload}" /> that matches; otherwise
        ///     <see langword="false" />.
        /// </returns>
        ...
        ///     <see cref="CompositePresentationEvent{TPayload}" /> will maintain a <seealso cref="WeakReference" /> to the target
        ...
        ///     CompositePresentationEvent will maintain a <seealso cref="WeakReference" /> to the Target of the supplied
        ...
        ///     <seealso cref="CompositePresentationEvent{TPayload}" /> keeps a reference to the subscriber so it does not get
        ///     garbage collected.
        /// </param>
        /// <returns>A <see cref="SubscriptionToken" /> that uniquely identifies the added subscription.</returns>
        /// <remarks>
        ...
        ///     <see cref="CompositePresentationEvent{TPayload}" /> will maintain a <seealso cref="WeakReference" /> to the Target
        ///     of the supplied <paramref name="action" /> delegate.
        ///     If not using a WeakReference (<paramref name="keepSubscriberReferenceAlive" /> is <see langword="true" />), the
        ///     user must explicitly call Unsubscribe for the event when disposing the subscriber in order to avoid memory leaks or
        ///     unexepcted behavior.
        ///     <para />
        ///     The CompositePresentationEvent collection is thread-safe.
        /// </remarks>
