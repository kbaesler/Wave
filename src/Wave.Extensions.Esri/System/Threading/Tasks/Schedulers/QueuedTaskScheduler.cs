...
{
    /// <summary>
    ///     Offers a task scheduler that provides control over fairness, priorities and the underlying threads used. It offers
    ///     many constructors with diverse number of parameters that allow you to control the threads to create and use for
    ...
    public sealed class QueuedTaskScheduler : TaskScheduler, IDisposable
    {
        ...
        /// <summary>Initializes the scheduler.</summary>
        /// <param name="targetScheduler">The target underlying scheduler onto which this sceduler's work is queued.</param>
        /// <param name="degreeOfParallelism">The maximum degree of concurrency allowed for this scheduler's work.</param>
            ...
            int degreeOfParallelism)
        {
            ...
            _ConcurrencyLevel = degreeOfParallelism != 0 ? degreeOfParallelism : Environment.ProcessorCount;
        ...
        #region Nested Type: QueuedTaskSchedulerDebugView
        ...
        private class QueuedTaskSchedulerDebugView
        {
            ...
            public IEnumerable<Task> ScheduledTasks
            {
                get
                {
                    var tasks = (_scheduler._TargetScheduler != null) ? (IEnumerable<Task>) _scheduler._NonthreadsafeTaskQueue : (IEnumerable<Task>) _scheduler._BlockingTaskQueue;
        ...
        #region Nested Type: QueuedTaskSchedulerQueue
        ...
        private sealed class QueuedTaskSchedulerQueue : TaskScheduler, IDisposable
        {
            ...
            #region Nested Type: QueuedTaskSchedulerQueueDebugView
