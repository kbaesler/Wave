...
namespace Wave.Geoprocessing.Toolbox.Management
{
    ...
    /// </summary>
    public class RemoveRelationshipAutoUpdaterFunction : BaseConfigTopLevelFunction
    {
        #region Constructors
        ...
        public RemoveRelationshipAutoUpdaterFunction(IGPFunctionFactory functionFactory)
        ...
        public override IArray ParameterInfo
        {
            get
            {
                ...
                array.Add(this.CreateMultiValueParameter("in_create", "Create", esriGPParameterType.esriGPParameterTypeOptional, esriGPParameterDirection.esriGPParameterDirectionInput, new GPStringTypeClass(), true));
                array.Add(this.CreateMultiValueParameter("in_delete", "Delete", esriGPParameterType.esriGPParameterTypeOptional, esriGPParameterDirection.esriGPParameterDirectionInput, new GPStringTypeClass(), true));
        ...
        {
            IGPValue dataElement = utilities.UnpackGPValue(parameters["in_table"]);
            if (!dataElement.IsEmpty())
            {
                IRelationshipClass relClass = utilities.OpenRelationshipClass(dataElement);
                if (relClass != null)
                {
                    ...
                    createParameter.Domain = base.GetComponents(relClass, mmEditEvent.mmEventRelationshipCreated);
                    ...
                    deleteParameter.Domain = base.GetComponents(relClass, mmEditEvent.mmEventRelationshipDeleted);
                }
            }
        }
