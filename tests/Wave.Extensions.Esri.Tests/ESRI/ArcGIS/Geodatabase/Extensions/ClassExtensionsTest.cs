...
namespace Wave.Extensions.Esri.Tests
{
    ...
    public class ClassExtensionsTest : EsriTests
    {
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("kellyl", ComparisonOperator.EndsWith, LogicalOperator.Or);
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("6", ComparisonOperator.EndsWith, LogicalOperator.Or);
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("kellyl", ComparisonOperator.Like, LogicalOperator.Or);
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("6", ComparisonOperator.Like, LogicalOperator.Or);
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("kellyl", ComparisonOperator.StartsWith, LogicalOperator.Or);
        ...
        {
            var testClass = base.GetTestClass();
            var filter = testClass.CreateQuery("6", ComparisonOperator.StartsWith, LogicalOperator.Or);
